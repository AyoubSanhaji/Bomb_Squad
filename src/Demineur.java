...
public class Demineur extends JFrame implements MouseListener,ActionListener
{
	...
	{
		//1
		String pathPref = getClass().getResource("Images").getPath();
		images = new ArrayList<ImageIcon>();
		ImageIcon i1 = new ImageIcon(pathPref+"/1.gif");
		images.add(i1);
		ImageIcon i2 = new ImageIcon(pathPref+"/2.gif");
		images.add(i2);
		ImageIcon i3 = new ImageIcon(pathPref+"/3.gif");
		images.add(i3);
		ImageIcon i4 = new ImageIcon(pathPref+"/4.gif");
		images.add(i4);
		ImageIcon i5 = new ImageIcon(pathPref+"/5.gif");
		images.add(i5);
		ImageIcon i6 = new ImageIcon(pathPref+"/6.gif");
		images.add(i6);
		ImageIcon i7 = new ImageIcon(pathPref+"/7.gif");
		images.add(i7);
		ImageIcon i8 = new ImageIcon(pathPref+"/8.gif");
		images.add(i8);
		ImageIcon i9 = new ImageIcon(pathPref+"/drapeau.gif");
		images.add(i9);
		ImageIcon i10 = new ImageIcon(pathPref+"/erreur.gif");
		images.add(i10);
		ImageIcon i11 = new ImageIcon(pathPref+"/mine.gif");
		images.add(i11);
		ImageIcon i12 = new ImageIcon(pathPref+"/nouveau jeu.gif");
		images.add(i12);
